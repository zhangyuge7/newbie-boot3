...
import com.newbie.common.domain.*;
...
public class SystemInfoUtil {
    ...
    public static void print() throws Exception {
        ...
        System.out.println("当前JVM占用的内存总数："+ formatData(jvmInfo.getTotal()));
        System.out.println("JVM最大可用内存总数："+ formatData(jvmInfo.getMax()));
        System.out.println("JVM空闲内存："+ formatData(jvmInfo.getFree()));
        System.out.println("JVM已用内存："+ formatData(usedJvmMemory));
        System.out.println("JVM内存使用率：" + formatRate(usageJvmMemory));
        System.out.println("JDK版本："+ jvmInfo.getVersion());
        System.out.println("JDK路径："+ jvmInfo.getHome());
        ...
        System.out.println("系统正常运行时长："+ osInfo.getRunTime());
        //运行时信息
